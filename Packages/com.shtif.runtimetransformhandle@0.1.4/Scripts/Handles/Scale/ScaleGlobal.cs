...
namespace RuntimeHandle
{
    ...
    public class ScaleGlobal : HandleBase
    {
        ...
        public ScaleGlobal Initialize(RuntimeTransformHandle p_parentTransformHandle, Vector3 p_axis, Color p_color, float p_handleSize)
        {
            ...
            mf.mesh = MeshUtils.CreateBox(.35f*p_handleSize, .35f*p_handleSize, .35f*p_handleSize);
