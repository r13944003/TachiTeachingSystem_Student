...
namespace RuntimeHandle
{
    ...
    public class PositionPlane : HandleBase
    {
        ...
        public PositionPlane Initialize(RuntimeTransformHandle p_runtimeHandle, Vector3 p_axis1, Vector3 p_axis2, Vector3 p_perp, Color p_color, float p_handleSize)
        {
            ...
            mf.mesh = MeshUtils.CreateBox(.02f, .5f*_handleSize, 0.5f*_handleSize);
            ...
            _handle.transform.localPosition = (_axis1 + _axis2) * .25f * _handleSize;
        ...
        void Update()
        {
            ...
            _handle.transform.localPosition = (axis1 + axis2) * .25f * _handleSize;
        }
    }
}