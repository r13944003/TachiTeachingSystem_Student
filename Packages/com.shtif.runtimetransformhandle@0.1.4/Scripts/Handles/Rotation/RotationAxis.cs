...
namespace RuntimeHandle
{
    ...
    public class RotationAxis : HandleBase
    {
        ...
        public RotationAxis Initialize(RuntimeTransformHandle p_runtimeHandle, Vector3 p_axis, Color p_color, float p_handleSize)
        {
            _handleSize = p_handleSize;
            ...
            mf.mesh = MeshUtils.CreateTorus(2f*_handleSize, .05f*_handleSize, 32, 6);
            MeshCollider mc = o.AddComponent<MeshCollider>();
            mc.sharedMesh = MeshUtils.CreateTorus(2f*_handleSize, .1f*_handleSize, 32, 6);
        ...
        public override void Interact(Vector3 p_previousPosition)
        {
            ...
            {
                _parentTransformHandle.target.rotation = _startRotation * Quaternion.AngleAxis(angleDegrees, _axis);
            }
            else
            {
            ...
            _arcMesh = MeshUtils.CreateArc(transform.position, _hitPoint, _rotatedAxis, 2*_handleSize, angleRadians, Mathf.Abs(Mathf.CeilToInt(angleDegrees)) + 1);
            DrawArc();
        ...
        public override void StartInteraction(Vector3 p_hitPoint)
        {
            ...
            _startRotation = _parentTransformHandle.target.rotation;
